...
export const featureOverview: FeatureOverview[] = [
  {
    ...
    description:
      "Instantly generated executive summaries with visuals and profit insights.",
    href: "#cfo-narratives",
  },
  {
    title: "Comparison Engine",
    description:
      "Compare stores, months, KPIs with dynamic graphs and narrative analysis.",
    href: "#comparison-engine",
  },
  {
    title: "Trend Analysis",
    description:
      "Track month-to-month or quarter-to-quarter performance trends.",
    href: "#trend-analysis",
  },
  {
    title: "Interactive Chatbot",
    description:
      "Ask finance questions in natural language and get instant visual+text answers.",
    href: "#chatbot",
  },
];
