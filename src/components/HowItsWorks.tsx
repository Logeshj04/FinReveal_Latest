...
const HowItsWorks = () => {
  ...
  useEffect(() => {
    ...
    if (howItWorksFeatures && howItWorksFeatures.length > 0) {
      ...
      }, 5000); // Auto-advance every 4 seconds
  ...
  return (
    ...
    >
      ...
      <h1 className="mb-10 lg:mx-30 text-4xl lg:text-6xl text-center font-semibold tracking-wide ">
        ...
        <span className="text-3xl lg:text-6xl bg-blue-500 text-transparent bg-clip-text mt-2">
          Strategic Insights
        </span>
      </h1>
      ...
      <div className="w-full max-w-3xl my-5 px-6 group transition-transform duration-500 ease-in-out">
        <div className="overflow-hidden rounded-[8px] shadow-sm group-hover:shadow-1xl group-hover:shadow-blue-400 transition-all duration-500">
          <img
            src={excelToInsightPng}
            alt="Excel to FinReveal Insights Flow"
            className="w-full h-auto drop-shadow-lg transform group-hover:scale-105  transition-transform duration-500 ease-in-out"
          />
        </div>
      </div>
      ...
      <div className="flex justify-center mb-12">
        <a
          href="/contact"
          className="bg-[#1565D8] text-[#FAFAFA] hover:bg-[#1359c7] font-semibold py-3 px-6 mx-3 rounded-[8px] shadow hover:scale-105 transition duration-300"
        >
          Get Started
        </a>
        <a
          href="/contact"
          className="py-3 px-6 mx-3 rounded-[8px] bg-[#F7FAFF] border border-[#1565D8] text-[#292929] font-medium hover:bg-teal-50 transition duration-300"
        >
          Learn More
        </a>
      </div>
      ...
      <div className="mb-16 mt-8 px-4">
        ...
        <div className="relative max-w-4xl mx-auto mb-12 px-4">
          ...
          <div className="h-1 w-full bg-gray-200 rounded-full mb-2">
            <motion.div
              className="h-1 bg-[#1565Db] rounded-full"
              animate={controls}
        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-8">
            {/* Icon */}
            <motion.div
              className="flex-shrink-0 w-24 h-24 rounded-full bg-blue-100 flex items-center justify-center shadow-lg"
            ...
            <div className="flex-1">
              <h3 className="text-2xl font-bold mb-3 bg-blue-800  to-teal-400 text-transparent bg-clip-text">
              ...
              <a
                ...
                className="inline-flex items-center text-[#00000] font-medium hover:text--800 transition-colors"
              >
      ...
      <section className="w-full max-w-5xl mx-auto px-6 mb-8">
        <motion.h2
          ...
          className="text-3xl md:text-4xl font-semibold mb-8 text-center bg-blue-500 to-teal-400 text-transparent bg-clip-text"
        >
          See FinReveal in Action
        </motion.h2>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          ...
          transition={{ duration: 0.5 }}
          viewport={{ once: true }}
          className="rounded-3xl overflow-hidden shadow-lg mt-12 border-3 border-blue-500 hover:shadow-0.5xl hover:shadow-blue-400 transition-all duration-300"
          style={{ height: "500px" }}
        >
          <iframe
            className="w-full h-full rounded-2xl"
            src="https://www.youtube.com/embed/gqomrPvX914"
            title="FinReveal Demo"
            frameBorder="0"
      ...
      <section
        ...
        className="bg-white py-20 px-15 text-center"
      >
        {/* Heading */}
        <motion.h2
          initial={{ opacity: 0, y: 0 }}
          ...
          transition={{ duration: 0.5 }}
          viewport={{ once: true, amount: 0.5 }}
          className="text-4xl md:text-5xl font-semibold mb-8 bg-blue-500 text-transparent bg-clip-text "
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto">
          {featureOverview.map((feature, index) => (
            <motion.a
              ...
              viewport={{ once: true }}
              className="bg-white p-8 rounded-3xl border border-gray-200 shadow-md hover:shadow-lg hover:shadow-blue-400/30 transition-all duration-300 text-left"
            >
              <h3 className="text-2xl font-semibold bg-blue-500 text-transparent bg-clip-text mb-2">
                {feature.title}
              </h3>
