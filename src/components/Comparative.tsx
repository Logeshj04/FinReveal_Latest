...
import comparisonImage from "../assets/comparisonImg2.png"; // Your comparison visual
...
const ComparisonEngine = () => {
  return (
    <section id="comparison-engine" className="bg-gray-50 py-20 px-13 md:px-12">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl md:text-5xl font-extrabold text-blue-500 mb-6 leading-tight">
            Comparison Engine
          </h2>
          ...
          <ul className="space-y-6 text-gray-600 font-medium mt-8">
            <li className="flex items-center space-x-4">
              <motion.div whileHover={{ scale: 1.2 }} className="text-blue-700">
                <Store size={28} />
              </motion.div>
          ...
          <div className="mt-10">
            <a
              href="#"
              className="inline-block bg-[#1565D8] text-[#FAFAFA] font-semibold py-3 px-6 rounded-[8px] hover:scale-105 transition duration-300"
            >
